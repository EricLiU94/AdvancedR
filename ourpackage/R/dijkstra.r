...
#' three rows, the first two rows descripts which connections are available
#' the last row indicates the weight function
#' initial_node: the starting node, from which the trip starts
