#' Determine the shortest path, from the intial node, to all the other nodes, which are included in the network
#' 
#' @export dijkstra
#' @param graph a data frame, which contains three parameters: the connection path between two nodes and a weight function
...
#' init_node = 1           
#' 
#' @references \url{https://sv.wikipedia.org/wiki/Dijkstras_algoritm}
